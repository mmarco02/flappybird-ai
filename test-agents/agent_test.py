...
def create_q_model():
    ...
    dense = layers.Dense(24, activation="relu")(dense2)
...
if os.path.exists("saved/q_model.keras") and os.path.exists("saved/target_q_model.keras"):
    model = keras.models.load_model("saved/q_model.keras")
    model_target = keras.models.load_model("saved/target_q_model.keras")
    print("Model Loaded")
else:
...
try:
    ...
    for episode in range(num_episodes):
        ...
        for timestep in range(1, max_steps_per_episode):
            ...
            observation, reward, episode_ended, _ = env.step(action)
            ...
            done_history.append(episode_ended)
        ...
        if episode % 50 == 0 or episode == num_episodes - 1:
            if not os.path.exists("saved"):
                os.makedirs("saved")
            model.save("saved/q_model.keras")
            model_target.save("saved/target_q_model.keras")
